...
void main() {
  ...
  */
  if(gl_GlobalInvocationID.x < 3200u && gl_GlobalInvocationID.y < 2400u) {
    ...
    */
    ...
    uint oIdx = (3200u * gl_GlobalInvocationID.y + gl_GlobalInvocationID.x) * 4u;
    imageData[oIdx] = color.r;
    imageData[oIdx+1u] = color.g;
    imageData[oIdx+2u] = color.b;
    imageData[oIdx+3u] = color.a;
  }
}
